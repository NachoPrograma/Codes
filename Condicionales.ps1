...
Write-Host "`nCONDICIONAL if con else" 
...
Write-Host "`nCONDICIONAL elseif" 
...
Write-Host "`nCONDICIONAL if ASIGNANDO VALOR A VARIABLE" 
...
Write-Host "`nCONDICIONAL SWITCH"
